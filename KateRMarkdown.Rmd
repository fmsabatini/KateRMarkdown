...
That's why we are playing around wit `RMarkdown` today.  
...
```{r, if (knitr::is_html_output()), warning=F, message=F, echo=F}
library(kableExtra)
knitr::kable(big.cats, caption="The largest cats!") %>%
  kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"), 
...
Good news - is possible - There are many templates out there, and you just have to reach out to them. See for instance: https://t.co/uJBqWER5h6?amp=1  
